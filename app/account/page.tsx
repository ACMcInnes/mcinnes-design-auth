                ...
                <dl className="divide-y divide-gray-100 dark:divide-white/10">
                  <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    ...
                    <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0 dark:text-gray-400 break-all">
                      {account.user.uid === account.user.preferred_username
                        ? account.user.uid
                        : `${account.user.preferred_username} (${account.user.uid})`}
                    </dd>
                  </div>
                  <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    <dt className="text-sm/6 font-medium text-gray-900 dark:text-gray-100">
                  ...
                  <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    ...
                    <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0 dark:text-gray-400">
                      {account.webstore.business_name}
                    </dd>
                  </div>
                  <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    <dt className="text-sm/6 font-medium text-gray-900 dark:text-gray-100">
                    ...
                    <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0 dark:text-gray-400">
                      ...
                      >
                        <ArrowTopRightOnSquareIcon className="inline-block size-6" />
                      </Link>
                    </dd>
                  </div>
                  <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    ...
                    <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0 dark:text-gray-400">
                      {account.webstore.country
                        ? `${account.webstore.country} - ${account.webstore.timezone}`
                        : `${account.webstore.timezone}`}
                    </dd>
                  </div>
                </dl>
              </div>
